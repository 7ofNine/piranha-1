...
#define PIRANHA_VERSION 0.10
#define PIRANHA_GIT_REVISION 46c2a315acac11fd2bd338e277ef6d2e537dcc8a
#define PIRANHA_HAVE_SYSTEM_LOGICAL_PROCESSOR_INFORMATION
