...
BOOST_AUTO_TEST_CASE(series_fp_coefficient_test)
{
...
#if defined(MPPP_WITH_MPFR)
    {
        ...
        pt2 x{"x"};
        BOOST_CHECK((pt2(0.) * pt2(real{"inf",100})).size() == 1u);
        BOOST_CHECK((pt2(0.) * pt2(real{"nan",100})).size() == 1u);
        BOOST_CHECK((0. * pt2(real{"inf",100})).size() == 1u);
        BOOST_CHECK((0. * pt2(real{"nan",100})).size() == 1u);
        BOOST_CHECK((pt2(real{"inf",100}) * 0.).size() == 1u);
        BOOST_CHECK((pt2(real{"nan",100}) * 0.).size() == 1u);
        BOOST_CHECK((pt2(0.) * real{"inf",100}).size() == 1u);
        BOOST_CHECK((pt2(0.) * real{"nan",100}).size() == 1u);
        BOOST_CHECK((real{"inf",100} * pt2(0.)).size() == 1u);
        BOOST_CHECK((real{"nan",100} * pt2(0.)).size() == 1u);
        BOOST_CHECK((pt2(0.) * pt2(-real{"inf",100})).size() == 1u);
        BOOST_CHECK((pt2(0.) * pt2(-real{"nan",100})).size() == 1u);
        BOOST_CHECK((0. * pt2(-real{"inf",100})).size() == 1u);
        BOOST_CHECK((0. * pt2(-real{"nan",100})).size() == 1u);
        ...
        BOOST_CHECK((pt2(0.) * (pt2(real{"inf",100}) + x)).size() == 1u);
        BOOST_CHECK((pt2(0.) * (pt2(real{"nan",100}) + x)).size() == 1u);
        BOOST_CHECK((0. * (pt2(real{"inf",100}) - x)).size() == 1u);
        BOOST_CHECK((0. * (pt2(real{"nan",100}) - x)).size() == 1u);
        BOOST_CHECK(((pt2(real{"inf",100}) + x) * 0.).size() == 1u);
        BOOST_CHECK(((pt2(real{"nan",100}) + x) * 0.).size() == 1u);
        BOOST_CHECK((pt2(0.) * (pt2(-real{"inf",100}) + x)).size() == 1u);
        BOOST_CHECK((pt2(0.) * (pt2(-real{"nan",100}) + x)).size() == 1u);
        BOOST_CHECK((0. * (pt2(-real{"inf",100}) - x)).size() == 1u);
        BOOST_CHECK((0. * (pt2(-real{"nan",100}) - x)).size() == 1u);
        ...
        tmp /= 0.;
        BOOST_CHECK((tmp.size() == 1u));
        BOOST_CHECK(piranha::pow(pt2(0.), real{"nan",100}).size() == 1u);
