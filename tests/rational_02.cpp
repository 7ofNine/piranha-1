...
struct boost_s11n_tester {
    ...
    void operator()(const T &) const
    {
        ...
        CHECK((has_boost_save<binary_oarchive, q_type>::value));
        CHECK((has_boost_save<binary_oarchive &, q_type>::value));
        CHECK((has_boost_save<binary_oarchive &, q_type &>::value));
        CHECK((has_boost_save<binary_oarchive &, const q_type &>::value));
        CHECK((!has_boost_save<void, const q_type &>::value));
        CHECK((!has_boost_save<const binary_oarchive &, const q_type &>::value));
        CHECK((has_boost_save<xml_oarchive, q_type>::value));
        CHECK((!has_boost_save<binary_iarchive, q_type>::value));
        CHECK((has_boost_load<binary_iarchive, q_type>::value));
        CHECK((has_boost_load<binary_iarchive &, q_type>::value));
        CHECK((has_boost_load<binary_iarchive &, q_type &>::value));
        CHECK((!has_boost_load<void, q_type &>::value));
        CHECK((!has_boost_load<binary_iarchive &, const q_type &>::value));
        CHECK((!has_boost_load<const binary_iarchive &, const q_type &>::value));
        CHECK((has_boost_load<xml_iarchive, q_type>::value));
        CHECK((!has_boost_load<binary_oarchive, q_type>::value));
        // A few simple checks.
...
TEST_CASE("rational_boost_s11n_test")
{
...
struct msgpack_s11n_tester {
    ...
    void operator()(const T &) const
    {
        ...
        CHECK((has_msgpack_pack<std::stringstream, q_type>::value));
        CHECK((has_msgpack_pack<msgpack::sbuffer, q_type>::value));
        CHECK((has_msgpack_pack<msgpack::sbuffer, q_type &>::value));
        CHECK((has_msgpack_pack<msgpack::sbuffer, q_type &&>::value));
        CHECK((has_msgpack_pack<msgpack::sbuffer, const q_type>::value));
        CHECK((!has_msgpack_pack<msgpack::sbuffer &, const q_type>::value));
        CHECK((!has_msgpack_pack<const msgpack::sbuffer, const q_type>::value));
        CHECK((!has_msgpack_pack<int, const q_type>::value));
        CHECK((!has_msgpack_pack<void, const q_type>::value));
        CHECK((has_msgpack_convert<q_type>::value));
        CHECK((has_msgpack_convert<q_type &>::value));
        CHECK((!has_msgpack_convert<const q_type>::value));
        CHECK((!has_msgpack_convert<const q_type &>::value));
        // A few simple checks.
...
TEST_CASE("rational_msgpack_s11n_test")
{
